...
export const DAILY_TIPS = [
  ...
  {
    id: 'tip-5',
    pt: 'Fazer pausas regulares ajuda os olhos a descansar e reduz o cansaço dos ecrãs.',
    en: 'Taking regular breaks helps your eyes rest and reduces screen fatigue.',
  },
];
    ...
    topics: [
      ...
      },
      {
        ...
        bulletPoints: [
          ...
          'posição confortável em relação ao ecrã;',
          'boa iluminação sem reflexos diretos;',
          'posição confortável dos braços e pulsos na mesa;',
          'pausas regulares para descanso dos olhos e do corpo;',
          'desligar ecrãs antes de dormir.',
        ],
        takeaway: 'Lembra-te: boa postura, distância confortável do ecrã, pausas ativas, descanso dos olhos e tempo sem ecrãs.',
      },
    ],
    simulators: [
      {
    ...
    topics: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'A IA não mente de propósito. Quando dá uma resposta errada, pode não perceber que a informação está errada.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Uma plataforma pode sugerir conteúdos parecidos com aquilo que já viste ou escolheste.',
          'Explora temas diferentes e decide por ti.',
        ],
...
// Grande Missão: A ESCOLA DO FUTURO (6 zonas, 150 XP)
